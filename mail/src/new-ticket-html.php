...
<div itemscope itemtype="http://schema.org/EmailMessage">
    ...
    <meta itemprop="description" content="<?= Yii::$app->getModule('ticket')->t('You\'ve received a ticket (#{ID}) from {APP}', ['ID'=>$model->id, 'APP'=>Yii::$app->name]) ?>"/>
</div>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <?= Yii::$app->getModule('ticket')->t('Greetings from {APP},', ['APP'=>Yii::$app->name]) ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <?= Yii::$app->getModule('ticket')->t('Ticket #{ID}', ['ID'=>$model->id]) ?><br>
                                        <?= Yii::$app->getModule('ticket')->t('Subject: {TITLE}', ['TITLE'=>$model->title]) ?><br>
                                ...
                                <tr>
                                    <td class="content-block aligncenter" colspan="2">
                                        <a href="<?= $model->getUrl(true) ?>" class="btn-primary"><?= Yii::$app->getModule('ticket')->t('View Ticket') ?></a>
                                    </td>
                                </tr>
